...
IMUSensor imu(SDA, SCL, scale_8g, scale_500dps, 0.06);
...
void loop()
{
    ...
    Axis<double> rotation_rate = imu.get_rotation_rate();
    ...
    angle_pitch += rotation_rate.x * 0.0004;
    angle_roll += rotation_rate.y * 0.0004;

    angle_pitch += angle_roll * sin(rotation_rate.z * 0.00007);
    angle_roll -= angle_pitch * sin(rotation_rate.z * 0.00007);
